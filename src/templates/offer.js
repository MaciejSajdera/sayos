...
const Offer = (props) => {
  ...
  let { about, menuRightProject, menuLeftProject, houseProject, interiorProject, designProject, category, offer } = props.data;
    ...
    <>
      ...
      <div className={`subpage`}>
        <div className="subpage-content-wrapper">
          ...
          <Link to={ about.locale === "pl" ? `/${designProject.slug}` : `/${designProject.locale}/${designProject.slug}`}>
            <LazyLoadImage
                              // alt={image.alt}
                              // height={image.height}
                              effect="blur"
